...
<div class="container-fluid">
  <h2 class="text-center"><?php echo $showTitle . " (" . $sendScore . " / " . $allStation . " หน่วย)"; ?></h2>
  <div class="row justify-content-md-center">
    ...
    foreach($scoreSumLeader as $key => $val) {
      ...
      echo '<div class="col-lg-1 d-none d-lg-block  border border-right-0 border-left-0 border-bottom-0">';
      if($index == 1) { $cssColor = ' text-dark ';} else { $cssColor = ' text-muted '; }
      echo '<p class="text-center display-3 ' . $cssColor . '">' . $index . '</p>';
      echo '</div>';
      echo '<div class="col-lg-2 d-none d-lg-block  text-center border border-right-0 border-left-0 border-bottom-0">';
      $imgPath = 'img/muk/' . $detailLeader[$key][zone] . '-'. $detailLeader[$key][no_candidate] . ".jpg";
      ...
      echo '</div>';
      echo '<div class="col-lg-3 col-md-4 border border-right-0 border-left-0 border-bottom-0">';
      ...
      echo '</div>';
      echo '<div class="col-lg-4 col-md-7 border border-right-0 border-left-0 border-bottom-0">';
